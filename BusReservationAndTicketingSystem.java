                ...
                for(int x=1; x==1;){
                    ...
                    for(x=1; x==1;){
                        ...
                        if (choice.equals("1")){
                            ...
                            System.out.println("***************************************");
                            System.out.println("** 1.)Jalanhar        |  Rs50  |   "+available[1]+"   **");
                            System.out.println("** 2.)Rama Mandi      |  Rs60  |   "+available[2]+"   **");
                            System.out.println("** 3.)LPU             |  RS80  |   "+available[3]+"   **");
                            System.out.println("** 4.)Phagwra         |  Rs120 |   "+available[4]+"   **");
                            System.out.println("** 5.)Ludhiana        |  Rs160 |   "+available[5]+"   **");
                            System.out.println("***************************************");
                            System.out.println("***************************************\n");
                            ...
                            if((available[1]==0)&&(available[2]==0)&&(available[3]==0)&&(available[4]==0)&&(available[5]==0)){
                                ...
                                for(x=1; x==1;){
                                    ...
                                    for(int l=0; l<z; l++){
                                        if(ticketS[l][0].equalsIgnoreCase(ticketS[z][0])){
                                            System.out.println("Sorry, Passenger's name have already used! Please use full name");
                                            x=1;
                                        }
                                    }
                                }
                                ...
                                String dest[] = { " ", "Jalanhar", "Rama Mandi", "LPU", "Phagwra", "Ludhiana"};
                                double fare[] = { 0,50,60,80,120,160};
                                ...
                                for(x=1; x==1;){
                                    ...
                                    ticketI[z][0] = Integer.parseInt(in.next());
                                ...
                                for(x=1;x==1;){
                                    ...
                                    ticketI[z][1] = Integer.parseInt(in.next());
                                    ...
                                    if(search.equalsIgnoreCase(ticketS[b][0])){
                                        ...
                                        if(ticketS[b][2].equals("x")){
                                            ...
                                            for(x=1; x==1;){
                                                ...
                                                pay[b] = Double.parseDouble(in.next());
